...
function Login() {
  ...
  return (
    <div className="max-w-lg h-4/5">
      <div className="max-w-3xl flex place-items-center justify-items-center lg:max-w-fit">
        <div className="md:max-w-fit sm:w-full sm:max-w-prose">
